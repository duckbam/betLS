		...
		<table class="table">
			...
			<tbody>
				<c:forEach var="dto" items="${bettingDB }">
					...
					<tr>
						<td><a href="bettingInfo?info=${dto.getNum()}"
							style="color: black; text-decoration-line: none;">${dto.getBetMoney()} USD</a></td>
						<td>${dto.getGame_result()}배</td>
						<td>${dto.getResult()} USD</td>
