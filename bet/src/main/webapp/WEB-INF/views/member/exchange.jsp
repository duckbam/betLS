...
<body>
	...
	<form id='f' action=exchangeProc method="post">
		<table style="margin-bottom: 140px; margin-top: 80px;">
			<tr>
				...
				<tr>
				<td>환전금액</td>
				<td><input type=number name='exchangeMoney1' placeholder='환전 금액 입력' class="form-control" maxlength="8" oninput="numberMaxLength(this);"/></td>
			</tr>
			<tr>
				<td align='center' height=40 colspan=4><input type=button
					value='환전' onclick="exchange()" class="btn btn-warning" style="width: 120px;" /> <input type=reset value='취소'
