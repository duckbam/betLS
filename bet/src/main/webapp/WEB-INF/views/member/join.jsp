	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" action="joinProc" method="post">
					<span class="login100-form-title p-b-32"> betLS Join </span> <span
					...
					<div class="wrap-input100 validate-input m-b-36"
						...
						<input class="input100" type="text" name="name" id="name" placeholder="_까지 입력"> 
						<span class="focus-input100"></span>
					</div>
					
					<span class="txt1 p-b-11"> 휴대폰번호 </span>
					<div class="wrap-input100 validate-input m-b-36"
						data-validate="휴대폰번호를 입력하세요!">
						<input class="input100" type="number" maxlength="6" name="phone" id="phone" 
					...
					<div class="wrap-input100 validate-input m-b-36"
						data-validate="계좌번호를 입력하세요!">
						<input class="input100" type="number" maxlength="10" name="account" id="account" 
						oninput="numberMaxLength(this);"> 
						<span class="focus-input100"></span>
					</div>
